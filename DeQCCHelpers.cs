...
namespace DeQcc
{
    ...
    partial class DeQCC
    {
        ...
        void InitStaticData()
        {
            ...
            pr_opcodes.Add(new Opcode(".", "ADDRESS", 1, false, Types.ev_entity, Types.ev_field, /*Types.ev_pointer*/Types.ev_field));
            ...
            pr_opcodes.Add(new Opcode("=", "STOREP_F", 5, true, /*Types.ev_pointer*/Types.ev_float, Types.ev_float, Types.ev_float));
            pr_opcodes.Add(new Opcode("=", "STOREP_V", 5, true, /*Types.ev_pointer*/Types.ev_vector, Types.ev_vector, Types.ev_vector));
            pr_opcodes.Add(new Opcode("=", "STOREP_S", 5, true, /*Types.ev_pointer*/Types.ev_string, Types.ev_string, Types.ev_string));
            pr_opcodes.Add(new Opcode("=", "STOREP_ENT", 5, true, /*Types.ev_pointer*/Types.ev_entity, Types.ev_entity, Types.ev_entity));
            pr_opcodes.Add(new Opcode("=", "STOREP_FLD", 5, true, /*Types.ev_pointer*/Types.ev_field, Types.ev_field, Types.ev_field));
            pr_opcodes.Add(new Opcode("=", "STOREP_FNC", 5, true, /*Types.ev_pointer*/Types.ev_function, Types.ev_function, Types.ev_function));
        ...
        void ReadProgsData(string outputfolder, string filename, bool decompile)
        {
